    ...
    methods
        function this = ZeroPadding2dLayer(name, Amounts)
            ...
            elseif isvector(Amounts)
                ...
                throwAsCaller(MException(message('yolov3:yolov3Detector:ZP2DAmounts')));
            end
            this.Name = name;
            this.Description = getString(message('yolov3:yolov3Detector:ZeroPadding2dDescription'));
            this.Type = getString(message('yolov3:yolov3Detector:ZeroPadding2dType'));
        end
